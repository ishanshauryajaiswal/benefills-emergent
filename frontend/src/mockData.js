// Mock data for Benefills e-commerce store
...
export const benefits = [
  {
    ...
    description: 'Steady energy. No crashes. Better focus.'
  },
  {
    icon: 'Heart',
    title: 'Better Absorption',
    description: 'Your body gets the minerals it\'s been missing.'
  },
  {
    icon: 'Sparkles',
    title: 'Grab & Go',
    description: 'Zero prep. Eat straight from the jar.'
  }
];
...
export const howItWorks = [
  {
    title: 'Grab & Go',
    description: 'Zero prep. Eat straight from the jar or pack. Morning, noon, or whenever hunger strikes.'
  },
  {
    title: 'Feel the Difference',
    description: 'Steady energy. No crashes. Better focus. Your body gets the minerals it\'s been missing.'
  },
  {
    title: 'Make It a Habit',
    description: 'Consistency > perfection. 1-2 servings daily supports long-term thyroid & hormone balance.'
  }
];

export const instagramPosts = [
  'https://images.unsplash.com/photo-1511688878353-3a2f5be94cd7?w=300&h=300&fit=crop',
  'https://images.unsplash.com/photo-1542838686-6a2c4e6df9ab?w=300&h=300&fit=crop',
  'https://images.unsplash.com/photo-1558961363-fa8fdf82db35?w=300&h=300&fit=crop',
  'https://images.unsplash.com/photo-1579954115545-a95591f28bfc?w=300&h=300&fit=crop',
  'https://images.unsplash.com/photo-1608877907149-a206d75ba011?w=300&h=300&fit=crop',
